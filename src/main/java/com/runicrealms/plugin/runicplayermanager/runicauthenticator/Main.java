...
import com.runicrealms.plugin.runicplayermanager.runicauthenticator.auth.authuser.UserCache;
...
import com.runicrealms.plugin.runicplayermanager.runicauthenticator.commands.CommandHandler;
import com.runicrealms.plugin.runicplayermanager.runicauthenticator.events.*;
...
public final class Main extends JavaPlugin {
    ...
    public void handlePlayer(Player player, UserData data)
        ...
        if (user.authenticated()) {
            if (player.hasPermission("runicauth.lock")) {
